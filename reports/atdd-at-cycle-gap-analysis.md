...
Comparison of `docs/atdd/process/at-cycle.md` against the internal/assets pages for AT-RED and AT-GREEN, in both `global/` and `runtime/` trees.

**Date:** 2026-05-16

## Sources compared

- `docs/atdd/process/at-cycle.md` (the compact spec)
