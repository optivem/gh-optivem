...
effort: medium
---
Write external-system contract tests against the existing DSL surface for the external system driver port(s) being changed.

## Inputs

- No per-invocation parameters; the contract-test target is the existing DSL surface visible in scope.
