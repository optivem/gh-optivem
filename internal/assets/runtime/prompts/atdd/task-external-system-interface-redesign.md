...
1. Identify the external system from the Checklist; locate its driver components under `${external-system-driver-adapter}/<external-system>/`: `XyzRealDriver`, `XyzStubDriver` (one per stub variant), `BaseXyzClient`, `Ext*` DTOs.
