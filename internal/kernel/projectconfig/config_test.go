...
system-test:
  ...
  paths:
    ...
    common-domain: system-test/java/src/main/java/testkit/domainvaluetypes/shop
...
system-test:
  ...
  paths:
    ...
    common-domain: system-test/src/main/java/testkit/domainvaluetypes/shop
...
system-test:
  ...
  paths:
    ...
    common-domain: system-test/src/main/java/testkit/domainvaluetypes/shop-backend
