...
> Generated from `internal/atdd/runtime/statemachine/process-flow.yaml` by `internal/atdd/runtime/diagram`. Do not edit by hand — edit the YAML and regenerate (`go generate ./...` or via the `gh optivem atdd show diagram` command).
