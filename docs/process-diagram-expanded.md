...
flowchart TD
    ...
    subgraph WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL[Write and Verify Acceptance Tests Fail]
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WAV_AT_FAIL_END(( ))
    subgraph WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS[Write and Verify Acceptance Tests]
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__SHARED_CONTRACT[Write and Verify Channel-Shared Acceptance Tests — see § shared-contract]
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_DSL_PORT_CHANGED{DSL Port Changed?}
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_SYSTEM_DRIVER_PORTS_CHANGED{System Driver Ports Changed?}
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__WAV_AT_END(( ))
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__IMPLEMENT_AND_VERIFY_SYSTEM_DRIVER_ADAPTERS["Implement and Verify System Driver Adapters — see § implement-and-verify-system-driver-adapters<br/>layer-suffix = <br/>suite = acceptance<br/>task-name = implement-system-driver-adapters<br/>test-category = acceptance<br/>verify-pending-on = none"]
    end
    end
    ...
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__SHARED_CONTRACT --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_DSL_PORT_CHANGED
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_DSL_PORT_CHANGED -- Yes --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_SYSTEM_DRIVER_PORTS_CHANGED
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_DSL_PORT_CHANGED -- No --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__WAV_AT_END
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_SYSTEM_DRIVER_PORTS_CHANGED -- Yes --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__IMPLEMENT_AND_VERIFY_SYSTEM_DRIVER_ADAPTERS
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_SYSTEM_DRIVER_PORTS_CHANGED -- No --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__WAV_AT_END
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__IMPLEMENT_AND_VERIFY_SYSTEM_DRIVER_ADAPTERS --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__WAV_AT_END
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__WAV_AT_END --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WAV_AT_FAIL_END
    ...
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_FAIL__WAV_AT_FAIL_END --> IMPLEMENT_AND_VERIFY_SYSTEM__RESOLVE_CHANNEL
...
flowchart TD
    COVER_END(( ))
    subgraph WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS[Write and Verify Acceptance Tests Pass]
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WAV_AT_PASS_END(( ))
    subgraph WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS[Write and Verify Acceptance Tests]
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__SHARED_CONTRACT[Write and Verify Channel-Shared Acceptance Tests — see § shared-contract]
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_DSL_PORT_CHANGED{DSL Port Changed?}
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_SYSTEM_DRIVER_PORTS_CHANGED{System Driver Ports Changed?}
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__WAV_AT_END(( ))
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__IMPLEMENT_AND_VERIFY_SYSTEM_DRIVER_ADAPTERS["Implement and Verify System Driver Adapters — see § implement-and-verify-system-driver-adapters<br/>layer-suffix = <br/>suite = acceptance<br/>task-name = implement-system-driver-adapters<br/>test-category = acceptance<br/>verify-pending-on = none"]
    end
    end

    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__SHARED_CONTRACT --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_DSL_PORT_CHANGED
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_DSL_PORT_CHANGED -- Yes --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_SYSTEM_DRIVER_PORTS_CHANGED
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_DSL_PORT_CHANGED -- No --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__WAV_AT_END
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_SYSTEM_DRIVER_PORTS_CHANGED -- Yes --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__IMPLEMENT_AND_VERIFY_SYSTEM_DRIVER_ADAPTERS
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__GATE_SYSTEM_DRIVER_PORTS_CHANGED -- No --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__WAV_AT_END
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__IMPLEMENT_AND_VERIFY_SYSTEM_DRIVER_ADAPTERS --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__WAV_AT_END
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WRITE_AND_VERIFY_ACCEPTANCE_TESTS__WAV_AT_END --> WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WAV_AT_PASS_END
    WRITE_AND_VERIFY_ACCEPTANCE_TESTS_PASS__WAV_AT_PASS_END --> COVER_END
```
