...
flowchart TD
    ...
    CALL_REFACTOR_SYSTEM_STRUCTURE --> CHOOSE_REFACTOR_TYPE
    CALL_REFACTOR_TEST_STRUCTURE --> CHOOSE_REFACTOR_TYPE
    CALL_REDESIGN_SYSTEM_STRUCTURE --> CHOOSE_REFACTOR_TYPE
