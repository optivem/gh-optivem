...
flowchart TD
    ...
    VERIFY_TESTS_FAIL_CONTRACT_REAL[Verify Contract Tests Fail Against the Real Simulator — see § verify-tests-fail]
    ...
    VERIFY_TESTS_PASS_CONTRACT_REAL_AFTER_SIMULATOR[Verify Contract Tests Pass Against the Real Simulator — see § verify-tests-pass]
    ...
    START_SYSTEM_AFTER_DRIVER --> GATE_REAL_KIND
    GATE_REAL_KIND -- Test Instance --> VERIFY_TESTS_PASS_CONTRACT_REAL
    VERIFY_TESTS_PASS_CONTRACT_REAL --> START_SYSTEM_BEFORE_STUB_FAIL
    GATE_REAL_KIND -- Simulator --> VERIFY_TESTS_FAIL_CONTRACT_REAL
    ...
    VERIFY_TESTS_PASS_CONTRACT_REAL_AFTER_SIMULATOR --> START_SYSTEM_BEFORE_STUB_FAIL
